...
from src.estimators.multilogistic_v1 import MultiLogistic
...
from test.estimators.testtools import XYTestEvent
from test.estimators.testtools import createXYTestFeature


class TestMultiLogistic(unittest.TestCase):
    ...
    def test_binary(self):
        ...
        prediction = mlee.predict(events, mlee['estimations'][0])
