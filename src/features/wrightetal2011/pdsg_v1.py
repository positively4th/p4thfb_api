...
from features.feature_v1 import Feature
from features.oppgoal.alloppgoalblockercount_v1 import AllOppGoalBlockerCount
...
class PDSG:
    ...
    @property
    def value(self):
        blockerCount = As(AllOppGoalBlockerCount)(self.row).value
