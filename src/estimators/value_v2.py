...
from src.estimators.multilogistic import MultiLogistic as MultiLogisticEstimator
from src.estimators.ols import OLS as OLSEstimator
...
from src.features.oppgoal.distance import Distance as OppGoalDistance
from src.features.oppgoal.probblockdefenders import ProbBlockDefenders as OppGoalProbBlockDefenders
from src.features.oppgoal.probblockgoalie import ProbBlockGoalie as OppGoalProbBlockGoalie
from src.features.oppgoal.width import Width as OppGoalWidth
...
class Value(Leaf):
    ...
    outcomeEventTypes = {
        Event.typeIdMap['Shot'],
        Event.typeIdMap['Half End'],
        Event.typeIdMap['Injury Stoppage']
    }

    valueEventTypes = {
        Event.typeIdMap['Shot'],
        Event.typeIdMap['Pass'],
        Event.typeIdMap['Carry']
    }
