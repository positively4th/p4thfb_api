...
class EventShotMapper(Leaf):
    ...
    queries = {
        ...
        'eventShot':
            ...
            from shot as _s
            left join "events<-shot" _es on _es.shot__id = _s.__id
            left join "events" _e on _e.__id = _es.events__id
        ...
        'filteredEventShot':
            '''
            select _s.*
            from :<eventShotFilter>: as _sf
            inner join :<eventShot>: as _s on _s.__id = _sf.__id
            '''.format(),
    }
